    ...
    <div class="main-section">
        ...
        <div class="marketingservice-table">
            <table class="table table-bordered mgb0">
                ...
                <tr>
                    <td class="icon-arr-r">
                        <a href="<?php echo $keywordAdUrl; ?>" target="_blank">키워드 광고</a>
                    </td>
                    <td class="icon-arr-r">
                        <a href="<?php echo $googleAdUrl; ?>" target="_blank">구글 광고</a>
                    </td>
                </tr>
                <tr>
                    <td class="icon-arr-r">
                        <a href="<?php echo $facebookAdUrl; ?>" target="_blank">페이스북 광고</a>
                    </td>
                    <td class="icon-arr-r">
                        <a href="<?php echo $retargetingAdUrl; ?>" target="_blank">리타겟팅 광고</a>
                    </td>
                </tr>
            </table>
        </div>
