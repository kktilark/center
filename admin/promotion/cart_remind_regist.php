    ...
    <table class="table table-cols">
        ...
        <tr>
            ...
            <td class="form-inline">
                ...
                <div class="notice-info">광고성 문구를 추가하려면 <b><a href="https://www.nhn-commerce.com/echost/power/add/convenience/sms-refusal-intro.gd
" target="_blank" class="text-blue">[080 수신거부 사용신청]</a></b>을 먼저 해주시기 바랍니다.</div>
            </td>
        </tr>
        <tr>
            <th>
