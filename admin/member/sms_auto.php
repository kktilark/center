    ...
    <table class="table table-cols">
        ...
        <tr>
            ...
            <td class="form-inline">
                ...
                <?php if ($smsPoint === '0') { ?>
                <div class="notice-danger">[SMS 설정]에 설정된 인증번호와 <a href="javascript:gotoGodomall('main');" class="btn-link text-red"><b>[마이페이지 > 쇼핑몰 관리]</b></a>에 설정된 인증번호가 일치해야 포인트 정보가 정상 출력됩니다.</div>
                <?php } ?>
            </td>
        </tr>
        <tr>
            ...
            <td class="form-inline">
                ...
                <div class="notice-danger font12"><a href="javascript:gotoGodomall('main');" class="btn-link text-red"><b>[마이페이지 > 쇼핑몰 관리]</b></a> 에서 SMS 인증번호를 확인 및 변경할 수 있습니다.</div>
                <div class="notice-danger font12">반드시 <a href="javascript:gotoGodomall('main');" class="btn-link text-red"><b>[마이페이지 > 쇼핑몰 관리]</b></a>에 설정된 SMS 인증번호와 동일한 번호로 설정하셔야만, SMS가 발송됩니다. (자동 SMS 포함, 다른 SMS 서비스 모두 해당됨)
</div>
            </td>
        </tr>
        <tr>
            ...
            <td class="form-inline">
                <?php if ($smsPreRegister === false) { ?>
                    <div>
                        ...
                        <?php if (gd_is_provider() === false) { ?>
                            <a href="https://www.nhn-commerce.com/mygodo/sms/intro.gd" target="_blank" class="btn btn-gray btn-sm">발신번호 등록하기</a>
                        <?php } ?>
                    </div>
                ...
                <div class="notice-danger">[SMS 설정]에 설정된 인증번호와 <a href="javascript:gotoGodomall('main');" class="btn-link text-red"><b>[마이페이지 > 쇼핑몰 관리]</b></a>에 설정된 인증번호가 일치해야 발신번호 정보가 정상 출력됩니다.</div>
                <?php } ?>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <?php } else { ?>
                    <div><b><a href="https://www.nhn-commerce.com/echost/power/add/convenience/sms-refusal-intro.gd" target="_blank" class="text-blue">[080 수신거부 사용신청]</a></b>을 먼저 해주시기 바랍니다.</div>
                <?php } ?>
