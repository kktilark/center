    ...
    <table class="table table-cols">
        ...
        <tr>
            ...
            <td class="form-inline">
                ...
                <div class="notice-info">블룸에이아이 계정이 없다면 <a href="https://lunasoft.co.kr/home/main/page/account/join" target="_blank" class="text-blue">[블룸에이아이 알림톡]</a>에서 등록해주세요.</div>
    ...
    <table class="table table-cols">
        ...
        <tr>
            ...
            <td class="form-inline">
                ...
                <div class="notice-danger mgt5"> <a href="https://lunasoft.co.kr/home/main/page/service/lunatalk" target="_blank" class="btn-link text-red">[블룸에이아이 알림톡 발신번호]</a>와 <a href="../member/sms_auto.php" target="_blank" class="btn-link text-red">[고도몰 SMS 발신번호]</a>가 동일해야 알림톡이 발송됩니다.</div>
...
<form id="frmLunaIdSend" name="frmLunaIdSend" method="post" target="ifrmLnkCheck" action="https://kakaoapi.godo.co.kr/lunaKakaoRequest.php">
